      ...
      <div className="max-w-4xl mx-auto p-4">
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <h1
              className="text-3xl font-bold bg-gradient-to-r from-green-500 to-teal-500 bg-clip-text text-transparent"
        ...
        >
          <Avatar mood="wellness" darkMode={darkMode} />
        </motion.div>

        {/* Wellness Mode Content */}
